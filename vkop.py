...
st.session_state.filial = st.sidebar.selectbox("Филиал", options=("ВЕЗА-Центр", "ВЕЗА-СПБ"))
...
if st.session_state.filial == "ВЕЗА-СПБ":
    ...
    st.session_state.engineer = st.sidebar.selectbox("Выполнил", options=tuple(map(lambda x: ' '.join(x.split()[:2]),("Назаров Шохназар", "Семенов Дмитрий",
                                                                                                                      ...
                                                                                                                      "Язынина Анастасия", "Федюкин Андрей", "Александров Вячеслав", "Филиппова Татьяна", "Глухов Евгений", "Матвеев Виталий", "Максимов Егор"
                                                                                                                     ))))
elif st.session_state.filial == "ВЕЗА-Центр":
